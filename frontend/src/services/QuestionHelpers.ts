...
import OpenEndedQuestionModelAnswerDetails from '@/models/statement/questions/OpenEndedQuestionModelAnswerDetails';
...
export enum QuestionTypes {
  ...
  OpenEndedQuestion = 'open_ended',
  ItemCombinationQuestion = 'item_combination'
}
...
export abstract class QuestionFactory {
  static getFactory(type: string): QuestionFactory {
    switch (type) {
      ...
      case QuestionTypes.OpenEndedQuestion:
        return new OpenEndedQuestionFactory();
      case QuestionTypes.ItemCombinationQuestion:
        return new ItemCombinationQuestionFactory(); // todo change me
      default:
...
class OpenEndedQuestionFactory extends QuestionFactory {
  ...
  createStatementQuestionDetails(details: any): StatementQuestionDetails {
    return new OpenEndedQuestionModelAnswerDetails(details);
  }
  createStatementAnswerDetails(details: any): StatementAnswerDetails {
