...
public enum ErrorMessage {
    ...
    NO_EMPTY_GROUP_ALLOWED("Item groups can't be empty"),
    AT_LEAST_TWO_ITEMS_NEEDED("At least one group must have two or more items"),
    VALID_CORRECT_ANSWER_NEEDED("Associations must be valid"),
    ...
    NO_MODEL_ANSWER("Open ended questions need to have a model answer."),
