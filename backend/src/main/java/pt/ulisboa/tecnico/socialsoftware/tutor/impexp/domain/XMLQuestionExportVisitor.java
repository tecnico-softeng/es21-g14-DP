...
public class XMLQuestionExportVisitor implements Visitor {
    ...
    public void visitQuestionDetails(OpenEndedQuestion question) {
        ...
        Element modelAnswerElement = new Element("modelAnswer");
        modelAnswerElement.setAttribute("value", question.getModelAnswer());
        this.currentElement.addContent(modelAnswerElement);
        this.currentElement = modelAnswerElement;
    }
    ...
    public void visitQuestionDetails(ItemCombinationQuestion question) {
        ...
        Element root = this.currentElement;

        Element groupLeftElement = new Element("groupLeft");
        this.currentElement.addContent(groupLeftElement);
        this.currentElement = groupLeftElement;
        question.visitGroupLeft(this);
        this.currentElement = root;

        Element groupRightElement = new Element("groupRight");
        this.currentElement.addContent(groupRightElement);
        this.currentElement = groupRightElement;
        question.visitGroupRight(this);
        this.currentElement = root;

        Element associationsElement = new Element("associations");
        this.currentElement.addContent(associationsElement);
        this.currentElement = associationsElement;
        question.visitAssociations(this);
        this.currentElement = root;
    }
    ...
    public void visitAssociation(Association association) {
        ...
        associationElement.setAttribute("left", String.valueOf(association.getLeft()));
        associationElement.setAttribute("right", String.valueOf(association.getRight()));
        this.currentElement.addContent(associationElement);
    }
