...
public abstract class LatexVisitor implements Visitor {
    ...
    public void visitQuestionDetails(OpenEndedQuestion question) {
        ...
        this.result +=
                String.format("\n\tModel answer: %s", question.getModelAnswer()) + "\n";
    ...
    public void visitItem(Item item) {
        this.result = this.result + "\t\\item" + "{" + item.getContent() + "}\n";
    }

    @Override
    public void visitAssociation(Association association) {
        this.result = this.result + "\t\\association" + "{" + association.getLeft() + ", " + association.getRight() +"}\n";
    }
