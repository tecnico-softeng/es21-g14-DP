...
class SpockTest extends Specification {
    ...
    public final static String USER_3_PASSWORD = "422"
    ...
    public static final String MODEL_ANSWER_1 = "Example of model answer 1"
    public static final String MODEL_ANSWER_2 = "Example of model answer 2"
    public static final String EMPTY_MODEL_ANSWER = " "
