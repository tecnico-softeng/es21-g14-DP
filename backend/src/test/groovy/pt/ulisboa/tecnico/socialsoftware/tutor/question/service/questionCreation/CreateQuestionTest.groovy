...
class CreateQuestionTest extends SpockTest {
    ...
    def "create a question with 2 correct answers"() {
        given: "a questionDto"
        def questionDto = new QuestionDto()
        questionDto.setKey(1)
        questionDto.setTitle(QUESTION_1_TITLE)
    ...
    def "create a question with 2 correct answers and 1 wrong"() {
        given: "a questionDto"
        def questionDto = new QuestionDto()
        questionDto.setKey(1)
        questionDto.setTitle(QUESTION_1_TITLE)
    ...
    def "create a question with 3 correct answers and test option sort"() {
        given: "a questionDto"
        def questionDto = new QuestionDto()
        questionDto.setKey(1)
        questionDto.setTitle(QUESTION_1_TITLE)
        ...
        resOption.get(1).getContent() == OPTION_1_CONTENT
        resOption.get(1).isCorrect()
        resOption.get(2).getContent() == OPTION_3_CONTENT
        resOption.get(2).isCorrect()
        Collections.sort(resOption, new MultipleChoiceQuestion.SortByRelevance());
